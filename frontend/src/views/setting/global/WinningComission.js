...
import {WinningComission} from "../../../configs/providerconfig"
...
class Casinopage extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {  
        if (prevProps.WinningComission !== this.props.WinningComission) {
            let row = this.props.WinningComission;
            this.setState({
                status : row.status,
    ...
    save = () => {
        ...
        let row = {
            type : WinningComission,
            content : {
                status : this.state.status,
                comission : this.state.comission,
            }
        }
        this.props.setGlobalConfig(row, GlobalType.GETWinningComission)
    }
...
const mapstop = state=>{
    return {
        WinningComission : state.setting.global.WinningComission
    }
}
