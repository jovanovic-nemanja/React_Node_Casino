...
router.post("/Slider_save",authMiddleware.isLoggedIn,multer({dest:config.BASEURL}).any(),CmsControll.save_sldierimgs);
...
router.post("/logoimg_save",authMiddleware.isLoggedIn,multer({dest:config.BASEURL}).any(),CmsControll.save_logos);
...
router.post("/upload_provider_paymentimg",authMiddleware.isLoggedIn,multer({dest:config.BASEURL}).any(),CmsControll.upload_provider_paymentimg);
