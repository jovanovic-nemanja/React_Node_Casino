...
import { ChevronDown,  ChevronLeft,  ChevronRight,Trash,ArrowDown,ArrowUp,Edit,Plus,Link,Edit2,Award} from "react-feather"
...
class Child extends Component {
    ...
    handleSubmit = (e)=>{
      ...
      if(!this.state.update){
        ...
        this.props.menuupdate([row],this.props.parsedFilter,this.props.bool);
      }
    ...
    rowEdit(row){
      this.me.setState({modal : true,title : row.title,text : row.navLink,rowid : row._id,update : true,ordernum : row.order,isChecked : row.status,icon : row.icon,mobileicon : row.mobileicon});
    }
