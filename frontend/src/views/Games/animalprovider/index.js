...
class Casinoprovider extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <Breadcrumbs breadCrumbTitle="Games" breadCrumbParent="Casino" />
        <Row>
          <Col sm="12">
            <ListViewConfig parsedFilter={queryString.parse(this.props.location.search)} bool ={providerconfig["ANIMAL"]} />
          </Col>
        </Row>
      </React.Fragment>
    )
